...
const getSubscriptions = async (req, res) => {
    try {
        ...
        const notificationPreference = req.query.notificationPreference ? (Array.isArray(req.query.notificationPreference) ? req.query.notificationPreference : [req.query.notificationPreference]) : [];
        ...
        if (notificationPreference.length) {
            searchCriteria.notificationPreference = { $in: notificationPreference };
        }
        ...
        res.render("subscriptions", {
            ...
            notificationPreference: req.query.notificationPreference || ''
        });
    } catch (error) {
